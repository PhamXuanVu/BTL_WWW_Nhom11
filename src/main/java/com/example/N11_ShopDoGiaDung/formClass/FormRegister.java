package com.example.N11_ShopDoGiaDung.formClass;
...
public class FormRegister {
	...
	public String toString() {
		return "FormRegister [hoTenDem=" + hoTenDem + ", ten=" + ten + ", soDienThoai=" + soDienThoai + ", email="
				+ email + ", matKhau=" + matKhau + ", nhapLaiMatKhau=" + nhapLaiMatKhau + "]";
	}
